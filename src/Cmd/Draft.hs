...
import Bricklayer.Blockify (blockifyToLayout)
import Bricklayer.BrickLayout (writeBrickLayout)
...
draftUsage =
    unlines
        ...
        , "  --output PATH   Output .blay file         [default: layouts/first.blay]"
